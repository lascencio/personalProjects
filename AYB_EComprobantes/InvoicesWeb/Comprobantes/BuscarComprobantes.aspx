    ...
    <div class="MyTable">
        ...
        <div class="MyRowDataEntry" style="margin-top:1%;">
            <asp:UpdatePanel runat="server" id="upInputs" updatemode="Conditional">
                <ContentTemplate>
                    <div class="MyCell" style="width:450px;">
                        <asp:CheckBox ID="chk1" Checked="true" runat="server" Text="Cliente" AutoPostBack="True" />
                        <br />
                        <asp:DropDownList ID="ddlClientes" runat="server" DataTextField="adesane" DataValueField="acodane" AutoPostBack="True" TabIndex="1" CssClass="MyDataEntry" Width="430px" />
                    </div>
                    <div class="MyCell" style="width:150px;">
                        <asp:CheckBox ID="chk2" runat="server" Text="Doc. Identidad" AutoPostBack="True" />  <br />
                      <asp:TextBox Enabled="false" ID="txtDocIdentidad" runat="server" AutoPostBack="True" MaxLength="10" TabIndex="7" CssClass="MyDateEntry" TextMode="Number" Font-Names="Arial Narrow" Font-Size="Small" Width="130px" />
                    </div>
                    ...
                    <div class="MyCell" style="width:110px;"><br />
