Public Class entUsuario
    ...
    Private m_codigo_empleado As String

    Private m_consultar_Horas As Boolean = False
    ...
    Public Sub New(ByVal Usuario As entUsuario)
        With Usuario
            ...
            m_codigo_empleado = .codigo_empleado

            m_consultar_Horas = .consultar_Horas
    ...
    Public Property codigo_empleado() As String
        Get
            Return m_codigo_empleado
        End Get
        Set(ByVal value As String)
            m_codigo_empleado = value
        End Set
    End Property

    Public Property consultar_Horas() As Boolean
        Get
            Return m_consultar_Horas
        End Get
        Set(ByVal value As Boolean)
            m_consultar_Horas = value
        End Set
    End Property
