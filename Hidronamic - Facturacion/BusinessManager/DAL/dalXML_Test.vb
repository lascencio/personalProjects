...
Imports BusinessManager.ServiceFacturacionSunat_Beta
Imports System.Net
Imports System.IO

Public Class dalXML_Test
    ...
    Class Program
        Private Shared Sub Main(args As String())
            ...
            Dim l_pwd As String = "GiQ5uTsBZ9gHxzNH"
    ...
    'Class Sunat
    '    Private wServiceED As billServiceClient

    '    Public Sub New()
    '        wServiceED = New billServiceClient()
    '        ServicePointManager.UseNagleAlgorithm = True
    '        ServicePointManager.Expect100Continue = False
    '        ServicePointManager.CheckCertificateRevocationList = True
    '    End Sub

    '    Public Function EnviarResumenBoletas_o_Baja(xmlzippeado As String) As String
    '        Dim sRetorno As String = ""

    '        Dim byteArray As [Byte]() = File.ReadAllBytes(xmlzippeado)

    '        Try
    '            wServiceED.Open()
    '            Dim ticket As String = wServiceED.sendSummary("nombrearchivozippeado", byteArray)
    '            wServiceED.Close()
    '            sRetorno = ticket
    '        Catch e As System.ServiceModel.FaultException
    '            sRetorno = e.Code.Name
    '        End Try
    '        Return sRetorno
    '    End Function
    ...
    '        'Try
    '        '    ServiceHost.Open()
    '        '    Dim returnString As statusResponse = ServicePoint.getStatus(pticket)
