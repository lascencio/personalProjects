...
Public Class frmENotaCreditoImprimir
    ...
    Private Sub frmENotaCreditoImprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.rvENotaCredito.LocalReport.EnableExternalImages = True

        Me.rvENotaCredito.LocalReport.SetParameters(MyParams)

        dsDetalles = dalVenta.ObtenerDetalles(Empresa, Venta)

        Me.rvENotaCredito.LocalReport.DataSources.Clear()
        Me.rvENotaCredito.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsCabecera", DirectCast(dsCabecera, DataTable)))
        Me.rvENotaCredito.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsDetalles", DirectCast(dsDetalles, DataTable)))
        Me.rvENotaCredito.DocumentMapCollapsed = True

        Me.rvENotaCredito.LocalReport.DisplayName = NombrePDF
        ...
        rvENotaCredito.PrinterSettings.PrinterName = NombreImpresora
        rvENotaCredito.PrinterSettings.Copies = 1

        Me.rvENotaCredito.RefreshReport()
        ...
        Dim bytes As Byte() = rvENotaCredito.LocalReport.Render("PDF", Nothing, mimeType, encoding, filenameExtension, streamids, warnings)
    ...
    Private Sub rvENotaCredito_Print(sender As Object, e As Microsoft.Reporting.WinForms.ReportPrintEventArgs) Handles rvENotaCredito.Print
