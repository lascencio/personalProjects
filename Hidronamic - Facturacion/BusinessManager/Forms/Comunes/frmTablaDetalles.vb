Public Class frmTablaDetalles
    ...
    Private Sub frmTablaDetalles_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub EvaluarCambios(ByVal Tipo_Accion As String)
        If Tipo_Accion = "MODIFICAR" Then
            ...
            MyTablaDetalle = dalTablaDetalle.Obtener(cmbEmpresa.SelectedValue, cmbTablas.SelectedValue, TD_Codigo)
        Else
        ...
        MyForm.ShowDialog()
        'If MyTablaDetalle.CancelProcess = "NOT" Then 
        ActualizarGrilla()
    End Sub

    Private Sub ActualizarTablas()
        If cmbEmpresa.SelectedIndex <> -1 Then
            cmbTablas.DataSource = dalTablaCabecera.ObtenerTablas(cmbEmpresa.SelectedValue)
        End If
    End Sub

    Private Sub ActualizarGrilla()
        gvElementos.DataSource = dalTablaDetalle.ObtenerDetalles(cmbEmpresa.SelectedValue, cmbTablas.SelectedValue, "T")
    ...
    Private Sub btnBorrar_Click() Handles UC_ToolBar.TB_btnBorrar_Click
        ...
        Else
            ...
            Else
                dalTablaDetalle.Borrar(cmbEmpresa.SelectedValue, cmbTablas.SelectedValue, TE_Codigo, TE_Nombre)
                ActualizarGrilla()
            End If
        End If
    End Sub
