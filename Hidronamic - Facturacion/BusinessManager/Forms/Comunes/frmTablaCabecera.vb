Public Class frmTablaCabecera
    ...
    Private Sub frmTablaCabecera_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmbNecesidad.DataSource = dalTablaDetalle.ObtenerDetalles("000", "NECESIDAD", "T")
        ...
        Else
            ...
            With MyTablaCabecera
                ...
                txtTexto1.Text = .ttexto_01
                txtTexto2.Text = .ttexto_02
                txtTexto3.Text = .ttexto_03
                txtTexto4.Text = .ttexto_04
                txtTexto5.Text = .ttexto_05
                ...
                cmbNecesidad.Enabled = IIf(.necesidad = "SISTEMAS", False, True)
                ckbActivo.Enabled = IIf(.necesidad = "SISTEMAS", False, True)
            End With
        End If
        ...
        If MyUsuario.privilegios = 4 Then
            If Me.Privilegios = 3 Then btnGrabar.Visible = True
        Else
    ...
    Private Sub Grabar()
        ...
        Try
            MyTablaCabecera = dalTablaCabecera.Grabar(MyTablaCabecera)
            Me.Close()
