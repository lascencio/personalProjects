Public Class frmLogin
    ...
    Private Sub frmLogin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            cmbUsuario.DataSource = ObtenerUsuarios()
    ...
    Private Sub btnAcceder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAcceder.Click
        If cmbModulo.SelectedIndex <> -1 Then
            Try
                ...
                MyMinimoDetraccion = MyDTEmpresas(cmbEmpresa.SelectedIndex).MINIMO_DETRACCION
                ...
                MyAfectoDetraccion = MyDTEmpresas(cmbEmpresa.SelectedIndex).AFECTO_DETRACCION
                ...
                If MyUsuario.es_conforme Then
                    'MyListaClientes = dalCuentaComercial.BuscarClientes()
