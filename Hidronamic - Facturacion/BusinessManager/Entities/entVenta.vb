Public Class entVenta
    ...
    Private m_orden_pago As String
    ...
    Public Property forma_pago() As String
        ...
        End Get
        Set(ByVal value As String)
            m_forma_pago = IIf(String.IsNullOrEmpty(value), "00", value)
        End Set
    End Property
    ...
    Public Property tipo_venta() As String
        ...
        End Get
        Set(ByVal value As String)
            m_tipo_venta = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property orden_compra() As String
        ...
        End Get
        Set(ByVal value As String)
            m_orden_compra = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property orden_pago() As String
        ...
        End Get
        Set(ByVal value As String)
            m_orden_pago = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property tipo_operacion() As String
        ...
        End Get
        Set(ByVal value As String)
            m_tipo_operacion = IIf(String.IsNullOrEmpty(value), "RI", value)
        End Set
    End Property
