Public Class entCuentaComercial
    ...
    Private m_credito_disponible_mn As Single
    Private m_credito_disponible_me As Single
    ...
    Public Sub New()
        ...
        Me.credito_disponible_mn = Nothing
        Me.credito_disponible_me = Nothing
    ...
    Public Sub New(ByVal CuentaComercial As entCuentaComercial)
        ...
        With CuentaComercial
            ...
            m_credito_disponible_mn = .credito_disponible_mn
            m_credito_disponible_me = .credito_disponible_me
    ...
    Public Property credito_disponible_mn() As Single
        Get
            Return m_credito_disponible_mn
        End Get
        Set(ByVal value As Single)
            m_credito_disponible_mn = IIf(String.IsNullOrEmpty(value), 0, value)
        End Set
    End Property

    Public Property credito_disponible_me() As Single
        Get
            Return m_credito_disponible_me
        End Get
        Set(ByVal value As Single)
            m_credito_disponible_me = IIf(String.IsNullOrEmpty(value), 0, value)
        End Set
    End Property
