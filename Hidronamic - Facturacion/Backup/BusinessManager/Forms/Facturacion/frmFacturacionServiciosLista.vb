Public Class frmFacturacionServiciosLista

    Private MyVenta As entVenta
    Private MyVentas As dsVentasLista.VENTAS_LISTADataTable
    ...
    Private Sub frmFacturacionServiciosLista_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cmbCuentaComercial.DataSource = dalCuentaComercial.BuscarCuentaComercial(MyUsuario.empresa, "", "C")
    ...
    Private Sub PoblarGrilla(ByVal CuentaComercial As String)
        MyVentas = New dsVentasLista.VENTAS_LISTADataTable
        MyVentas = dalVenta.BuscarVentas(MyUsuario.empresa, MyUsuario.ejercicio, Strings.Right("00" & MyUsuario.mes.ToString, 2), CuentaComercial)
