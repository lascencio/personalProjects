Public Class frmSubBase
    ...
    Public Sub New()
        ...
        MyTextboxSerie.AutoSize = False : MyTextboxSerie.ReadOnly = True : MyTextboxSerie.Width = 30 : MyTextboxSerie.Font = New Font("Arial Narrow", 12, FontStyle.Bold)
        MyTextboxNumero.AutoSize = False : MyTextboxNumero.ReadOnly = True : MyTextboxNumero.Width = 60 : MyTextboxNumero.Font = New Font("Arial Narrow", 12, FontStyle.Bold)
        ...
        '        DirectCast(MyPrintPreview.Controls(1), ToolStrip).Items(1).Margin = New System.Windows.Forms.Padding(0, 0, 850, 0)
        DirectCast(MyPrintPreview.Controls(1), ToolStrip).Items(1).Margin = New System.Windows.Forms.Padding(0, 0, 800, 0)
        DirectCast(MyPrintPreview.Controls(1), ToolStrip).Items(2).Margin = New System.Windows.Forms.Padding(0, 0, 10, 0)
