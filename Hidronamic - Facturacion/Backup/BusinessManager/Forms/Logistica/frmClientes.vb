Public Class frmClientes
    ...
    Private Sub AlinearTexto(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDocumentoNumero.Validated, txtCodigoVendedor.Validated, txtRazonSocial.Validated, txtEmail.Validated, txtDomicilio.Validated, txtReferencia.Validated, txtTelefono.Validated, txtCelular.Validated, txtApellidoPaterno.Validated, txtApellidoMaterno.Validated, txtNombre.Validated, txtCuentaBancariaMN.Validated, txtCuentaBancariaME.Validated, txtCuentaDetraccion.Validated, txtComentario.Validated, txtCodigoPostal.Validated
...
#Region "Botones"
    ...
    Private Sub btnGrabar_Click() Handles UC_ToolBar.TB_btnGrabar_Click
        ...
        With MyCuentaComercial
            ...
            .codigo_vendedor = txtCodigoVendedor.Text
        ...
        Try
            ...
            If txtCodigoVendedor.TextLength <> 0 Then dalCuentaComercial.GrabarVendedor(txtCodigoVendedor.Text, txtRazonSocial.Text, txtDocumentoNumero.Text)
...
#Region "Funciones"
    ...
    Private Sub LlenarFormulario()
        ...
        With MyCuentaComercial
            ...
            txtCodigoVendedor.Text = .codigo_vendedor
    ...
    Private Sub PonerValoresDefault()
        ...
        ckbIndicaCliente.Checked = True
        ckbIndicaProveedor.Checked = False
        ckbEstado.Checked = True
        Call DomicilioEnvio("", cmbDomicilioEnvio)
    End Sub
