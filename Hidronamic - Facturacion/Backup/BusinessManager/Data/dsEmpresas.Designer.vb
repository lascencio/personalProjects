...
Partial Public Class dsEmpresas
    ...
    Partial Public Class EMPRESASDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddEMPRESASRow(ByVal EMPRESA As String, ByVal RAZON_SOCIAL As String, ByVal IGV As Decimal, ByVal ISC As Decimal, ByVal DETRACCION As Decimal, ByVal RUC As String, ByVal DOMICILIO As String, ByVal DISTRITO As String, ByVal CUENTA_DETRACCION As String, ByVal CODIGO_CONCAR As String, ByVal ESTADO As String) As EMPRESASRow
            Dim rowEMPRESASRow As EMPRESASRow = CType(Me.NewRow,EMPRESASRow)
            Dim columnValuesArray() As Object = New Object() {EMPRESA, RAZON_SOCIAL, IGV, ISC, DETRACCION, RUC, DOMICILIO, DISTRITO, CUENTA_DETRACCION, CODIGO_CONCAR, ESTADO}
