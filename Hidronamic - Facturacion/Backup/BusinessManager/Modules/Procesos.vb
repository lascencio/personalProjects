...
Public Module Procesos
    ...
    'Public MyTemp As String = "C:\MyTemp"
    Public MyTemp As String = "C:\Temp"
    ...
    Public myConnectionStringSQL_StarSoft As String
    ...
    Sub New()
        ...
        myConnectionStringSQL_Concar = My.Settings.cnnSQLConcarD.ToString

        'myConnectionStringOleDB_Concar = My.Settings.cnnVFPDemo
        myConnectionStringOleDB_Concar = My.Settings.cnnJETDemo

        myConnectionStringSQL_StarSoft = My.Settings.cnnSQLStarSoft.ToString

        ''Produccion
        'myConnectionStringSQL_Repository = My.Settings.cnnSQLRepository.ToString
        'myConnectionStringSQL_Concar = My.Settings.cnnSQLConcar.ToString
