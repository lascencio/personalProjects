Public Class frmGuiaPorVentaOtros
    ...
    Private TipoOperacion As String = "G5" ' G2 Translado entre almacenes, G4 - Venta Vehicular, G5 - Venta Directa
    ...
    Private Sub txtComprobante_KeyDown(sender As Object, e As KeyEventArgs) Handles txtComprobante.KeyDown
        ...
        If MyKeyDown = Keys.Enter Or MyKeyDown = Keys.Return Then
            ...
            Dim MyForm As New frmVentaDirectaLista(MyVenta, txtEjercicio.Text, txtMes.Text, "TODOS", "TODOS", False)
            MyForm.ShowDialog()
    ...
    Private Sub cmbDomicilioEnvio_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbDomicilioEnvio.SelectedIndexChanged
        If cmbDomicilioEnvio.SelectedIndex <> -1 Then
            txtPuntoLlegada.Text = MyDireccionEnvio(0).DIRECCION
        Else
...
#Region "Funciones"
    ...
    Private Function CapturarEncabezadoGuia() As Boolean
        ...
        If txtPuntoLlegada.Text.Trim.Length = 0 Then MyMensaje = "PUNTO DE LLEGADA"
...
#Region "Botones"
    ...
    Private Sub UC_ToolBar_btnEditar_Click() Handles UC_ToolBar.TB_btnEditar_Click
        MyGuia = New entGuia
        Dim MyForm As New frmGuiaRemitenteLista(MyGuia, txtEjercicio.Text, txtMes.Text, "TODOS", TipoOperacion, "TODOS")
        MyForm.ShowDialog()
