Public Class frmOperacionDetalleSeriesVehiculares
    ...
    Private Sub frmOperacionDetalleSeriesVehiculares_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub GrabarSerie()
        ...
        Else
            ...
            If MyDetalle Is Nothing Then
                MyDetallesOperacionSeries.Rows.Add(MyUsuario.empresa, CUO_Nulo, CodigoProducto, txtNumeroSerie.Text, txtNumeroSerieChasis.Text, txtColor.Text, "A", "", Now.Date, "", Now.Date, "NO")
                MyDetallesOperacionSeriesProducto.Rows.Add(MyUsuario.empresa, CUO_Nulo, CodigoProducto, txtNumeroSerie.Text, txtNumeroSerieChasis.Text, txtColor.Text, "A", "", Now.Date, "", Now.Date, "NO")
                gvSeries.DataSource = MyDetallesOperacionSeriesProducto
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If NumeroSerie.Length <> 0 And NumeroSerieChasis.Length <> 0 And Color.Length <> 0 Then
            ...
            CantidadAtendida = CantidadAtendida + 1
            txtCantidadAtendida.Text = EvalDato(CantidadAtendida, txtCantidadAtendida.Tag)
            txtNumeroSerie.Text = Nothing : txtNumeroSerieChasis.Text = Nothing : txtColor.Text = Nothing
            txtNumeroSerie.Focus()
        End If
    End Sub
