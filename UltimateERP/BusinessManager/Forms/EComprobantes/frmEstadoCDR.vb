Public Class frmEstadoCDR
    ...
    Private Sub frmEstadoCDR_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub UC_ToolBar_TB_btnAceptar_Click() Handles UC_ToolBar.TB_btnAceptar_Click
        ...
        If cmbComprobanteTipo.SelectedIndex <> -1 And txtComprobanteSerie.Text.Trim.Length <> 0 And txtComprobanteNumero.Text.Trim.Length <> 0 Then
            ...
            Try
                ...
                If CodigoRetorno = "0127" Then ' El comprobante No Existe
                ...
                Else
                    ...
                    If dalVenta.ActualizarEstadoEnvio(MyUsuario.empresa, cmbComprobanteTipo.SelectedValue, txtComprobanteSerie.Text, "00" & txtComprobanteNumero.Text, IIf(CodigoRetorno = "0004", "A", "R")) = True Then
