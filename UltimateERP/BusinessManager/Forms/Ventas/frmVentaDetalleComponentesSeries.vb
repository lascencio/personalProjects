Public Class frmVentaDetalleComponentesSeries
    ...
    Public CantidadSolicitada As Decimal
    ...
    Public Sub New(ByVal pCodigoAlmacen As String, ByVal pCodigoProducto As String, ByVal pDescripcionProducto As String, pCodigoCompra As String, ByRef pCantidadSolicitada As Decimal, ByRef VentaDetalleSeries As dsVentas.VENTA_DET_SERIESDataTable)
        ...
        CodigoAlmacen = pCodigoAlmacen
        CodigoProducto = pCodigoProducto
        DescripcionProducto = pDescripcionProducto.Replace(pCodigoCompra.Trim & "; ", "")
        DescripcionProducto = DescripcionProducto.Replace(pCodigoCompra.Trim, "")
        CodigoCompra = pCodigoCompra
        CantidadSolicitada = pCantidadSolicitada
        MyVentaDetalleSeries = VentaDetalleSeries
    ...
    Private Sub frmVentaDetalleSeries_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
        txtCantidadSolicitada.Text = EvalDato(CantidadSolicitada, txtCantidadSolicitada.Tag)
        txtCantidadAtendida.Text = EvalDato(CantidadAtendida, txtCantidadAtendida.Tag)

        If CodigoCompra.Trim.Length <> 0 Then txtCodigoCompra.Text = CodigoCompra
        If DescripcionProducto.Trim.Length <> 0 Then txtDescripcionAmpliada.Text = DescripcionProducto
    ...
    Private Sub GrabarSerie()
        If CantidadAtendida + 1 > CantidadSolicitada Then
        ...
        Else
            ...
            If (MyDetalle Is Nothing) Then
                MyVentaDetalleSeries.Rows.Add(MyUsuario.empresa, CUO_Nulo, CodigoProducto, txtNumeroSerie.Text, "A", "NO")
                MyVentaDetalleSeriesProducto.Rows.Add(MyUsuario.empresa, CUO_Nulo, CodigoProducto, txtNumeroSerie.Text, "A", "NO")
                gvSeries.DataSource = MyVentaDetalleSeriesProducto
    ...
    Private Sub btnSalir_Click(sender As Object, e As EventArgs) Handles btnSalir.Click
        ...
        If CantidadAtendida <> CantidadSolicitada Then
