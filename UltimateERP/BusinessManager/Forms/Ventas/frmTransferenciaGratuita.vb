Public Class frmTransferenciaGratuita
...
#Region "Botones"
    ...
    Private Sub UC_ToolBar_btnEditar_Click() Handles UC_ToolBar.TB_btnEditar_Click
        ...
        MyVenta = New entVenta
        Dim MyForm As New frmFacturacionProductosLista(MyVenta, txtEjercicio.Text, txtMes.Text, "V", IIf(cmbComprobanteTipo.Text = "BOLETA", "B3", "F3"), "SN")
        MyForm.ShowDialog()
        If Not MyVenta.venta Is Nothing Then Call PoblarFormulario()
    End Sub
