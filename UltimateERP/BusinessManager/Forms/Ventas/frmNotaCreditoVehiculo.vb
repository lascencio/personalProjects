Public Class frmNotaCreditoVehiculo
    ...
    Private Sub frmNotaCreditoVehiculo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = Keys.Enter Then e.Handled = True : SendKeys.Send("{TAB}")
    End Sub

    Private Sub frmNotaCreditoVehiculo_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub BuscarReferencia()
        If cmbReferenciaTipo.SelectedIndex <> -1 And txtReferenciaSerie.Text.Trim.Length <> 0 And txtReferenciaNumero.Text.Trim.Length <> 0 Then
            ...
            If Not MyNotaCredito.venta Is Nothing Then
                ...
                MyVentaVehiculo = dalVenta.ObtenerVentaVehiculo(MyUsuario.empresa, MyReferenciaID)
...
#Region "Botones"
    ...
    Private Sub UC_ToolBar_btnAceptar_Click() Handles UC_ToolBar.TB_btnAceptar_Click
        If txtNotaCredito.Text.Trim.Length = 0 Then
            ...
            MyNotaCredito = dalVenta.GrabarNotaCreditoVehiculo(MyReferenciaID, MyNotaCredito, MyReferenciaDetalles, MyReferenciaDetallesSeries, MyVentaVehiculo)
