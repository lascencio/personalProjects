Public Class frmClientePersonaJuridica
    ...
    Private Sub frmClientePersonaJuridica_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub frmClientePersonaJuridica_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ActualizarListaEmpresa(cmbVendedor, "STD_VENDEDORES")
        ActualizarListaEmpresa(cmbZonaComercial, "OPE_ZONAS_COMERCIALES")
        ActualizarListaEmpresa(cmbItemFlujo, "CON_ITEM_FLUJO")

        ActualizarLista(cmbListaPrecios, "A")
        ActualizarLista(cmbGrupoComercial, "A")
    ...
    Private Sub txtDocumentoNumero_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDocumentoNumero.KeyDown
        ...
        If MyKeyDown = Keys.Enter Or MyKeyDown = Keys.Return Then
            ...
            If String.IsNullOrEmpty(MyDocumentoNumero) Then
                Dim MyForm As New frmCuentaComercialLista(MyCuentaComercial, "C", "SI")
                MyForm.ShowDialog()
            Else
    ...
    Private Sub ValidarDato_Validated(sender As Object, e As EventArgs) Handles txtLineaCreditoME.Validated, txtLineaCreditoMN.Validated, txtPorcentajeDetraccion.Validated
...
#Region "Funciones"
    ...
    Private Sub PonerValoresDefault()
        ...
        cmbVendedor.SelectedValue = "000"
        cmbGrupoComercial.SelectedValue = "G0000000"
        cmbListaPrecios.SelectedValue = "LP0000000000"
    ...
    Private Sub LlenarFormulario()
        With MyCuentaComercial
            ...
            cmbDomicilioEnvio.SelectedValue = .domicilio_envio
            ...
            cmbListaPrecios.SelectedValue = .lista_precios
            ...
            cmbVendedor.SelectedValue = .codigo_vendedor
            cmbZonaComercial.SelectedValue = .zona_comercial
            cmbGrupoComercial.SelectedValue = .grupo_comercial
            ...
            Call DomicilioEnvio(.empresa, .cuenta_comercial, cmbDomicilioEnvio)
            cmbDomicilioEnvio.SelectedValue = .domicilio_envio
        End With
    End Sub
    ...
    Private Sub ValidarDocumento(MyDocumentoTipo As String, MyDocumentoNumero As String)
        If MyDocumentoNumero.Length <> 0 Then
            If MyDocumentoNumero.Trim.Length = 11 Then
                If MyDocumentoNumero.Substring(0, 2) <> "20" Then
                    Resp = MsgBox("El RUC de una persona jurídica debe empezar con 20.", MsgBoxStyle.Critical, "PROCESO CANCELADO")
                    txtDocumentoNumero.Focus()
                Else
...
#Region "Botones"
    ...
    Private Sub UC_Toolbar_TB_btnGrabar_Click() Handles UC_ToolBar.TB_btnGrabar_Click
        ...
        If txtDocumentoNumero.Text.Trim.Length <> 0 Then
            ...
            If txtTelefono.Text.Trim.Length = 0 Then NombreCampo = "TELEFONO" : GrabarRegistro = False
