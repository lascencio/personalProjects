Public Class frmTablaDetalle
    ...
    Private MyCodigoTabla As String
    Private MyCodigoElemento As String
    ...
    Private Sub frmTablaDetalle_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub frmTablaDetalle_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        myTablaCabecera = dalTablasGenericas.Obtener(MyTablaDetalle.empresa, MyTablaDetalle.codigo_tabla)
        ...
        If lblTexto3.Text = "EMPRESA" And txtCodigoTabla.Text = "USUARIOS" Then
            ...
            cmbTexto3.DataSource = dalTablasGenericas.ObtenerDetalles(txtEmpresa.Text, "EMPRESAS", "T")
            cmbTexto3.Visible = True
            cmbTexto4.DataSource = dalTablasGenericas.ObtenerDetalles(txtEmpresa.Text, "USUARIOS", "T")
        ...
        If String.IsNullOrEmpty(MyTablaDetalle.codigo_item) Then
            ...
            EnableTextBox(txtCodigo, True)
        Else
            Me.Text = "MODIFICAR ELEMENTO"
            EnableTextBox(txtCodigo, False)
            With MyTablaDetalle
                txtCodigo.Text = .codigo_item
                txtDescripcion.Text = .nombre_corto
                txtDescripcionAmpliada.Text = .nombre_largo
                txtTexto1.Text = .texto_01.Trim
                txtTexto2.Text = .texto_02.Trim
                txtTexto3.Text = .texto_03.Trim
                txttexto4.Text = .texto_04.Trim
                txttexto5.Text = .texto_05.Trim
    ...
    Private Sub txtValor_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtValor1.Validated, txtValor2.Validated, txtValor3.Validated, txtValor4.Validated, txtValor5.Validated
    ...
    Private Sub txtCodigo_KeyDown(sender As Object, e As KeyEventArgs) Handles txtCodigo.KeyDown
        ...
        If MyKeyDown = Keys.Enter Or MyKeyDown = Keys.Return Then
            ...
            If sender.Text.Trim.Length <> 0 Then Call ValidarElemento()
        End If
    End Sub
    ...
    Private Sub ValidarElemento()
        MyCodigoTabla = txtCodigoTabla.Text
        MyCodigoElemento = txtCodigo.Text.Trim
        MyTablaDetalle = dalTablasGenericas.Obtener(MyTablaDetalle.empresa, MyCodigoTabla, MyCodigoElemento)
        If Not MyTablaDetalle.codigo_item Is Nothing Then
            Resp = MsgBox("El elemento " & MyCodigoElemento & " ya existe para la tabla " & MyCodigoTabla, MsgBoxStyle.Critical, "PROCESO DENEGADO")
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        If txtCodigo.Text.Trim.Length = 0 Then
            Resp = MsgBox("El campo ELEMENTO esta vacío." & vbCrLf & "Debe indicar un nombre para el elemento.", MsgBoxStyle.Critical, "PROCESO DENEGADO")
        Else
            ...
            Try
                MyTablaDetalle = dalTablasGenericas.Grabar(MyTablaDetalle)
