...
Public Class frmReporteUtilidadEspecifica
    ...
    Private MyUtilidadEspecificaProductos As dsCostos.UTILIDAD_ESPECIFICADataTable
    ...
    Private Sub frmReporteUtilidadProducto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        MyUtilidadEspecificaProductos = New dsCostos.UTILIDAD_ESPECIFICADataTable
    ...
    Private Sub ImprimirReporte(FechaDesde As Long, FechaHasta As Long)
        ...
        MyUtilidadEspecificaProductos = dalCostoPromedio.ObtenerUtilidadEspecificaProducto(MyUsuario.empresa, MyPeriodo, pAlmacen, pMarca, pModelo, pLinea, pSubLinea, pProducto, FechaDesde.ToString, FechaHasta.ToString)
        ...
        Me.rvUtilidadProducto.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsDetalles", DirectCast(MyUtilidadEspecificaProductos, DataTable)))
    ...
    Private Sub btnExportarExcel_Click(sender As Object, e As EventArgs) Handles btnExportarExcel.Click
        ...
        MyDC = New DataColumn("INFORMACION_COMPRA", Type.GetType("System.String")) : MyExcelReport.Columns.Add(MyDC)
        MyDC = New DataColumn("INFORMACION_VENTA", Type.GetType("System.String")) : MyExcelReport.Columns.Add(MyDC)
        MyDC = New DataColumn("DIAS", Type.GetType("System.Decimal")) : MyExcelReport.Columns.Add(MyDC)
        MyDC = New DataColumn("PRECIO_COMPRA", Type.GetType("System.Decimal")) : MyExcelReport.Columns.Add(MyDC)
        ...
        With MyExcelReport
            ...
            .Columns("INFORMACION_COMPRA").MaxLength = 1000
            .Columns("INFORMACION_VENTA").MaxLength = 1000
        End With

        If MyUtilidadEspecificaProductos.Rows.Count <> 0 Then
            For NEle As Integer = 0 To MyUtilidadEspecificaProductos.Rows.Count - 1
                With MyUtilidadEspecificaProductos(NEle)
                    ...
                    MyDR.Item("INFORMACION_COMPRA") = .COMPRA_COMPROBANTE & " " & .PROVEEDOR
                    MyDR.Item("INFORMACION_VENTA") = .VENTA_COMPROBANTE & " " & .CLIENTE
                    MyDR.Item("DIAS") = DateDiff(DateInterval.DayOfYear, .COMPRA_FECHA, .VENTA_FECHA)
                    If cmbTipoMoneda.SelectedValue = "1" Then
                        MyDR.Item("PRECIO_COMPRA") = .PRECIO_COMPRA_MN
                        MyDR.Item("PRECIO_VENTA") = .PRECIO_VENTA_MN
                        MyDR.Item("UTILIDAD") = .UTILIDAD_MN
                    Else
                        MyDR.Item("PRECIO_COMPRA") = .PRECIO_COMPRA_ME
                        MyDR.Item("PRECIO_VENTA") = .PRECIO_VENTA_ME
                        MyDR.Item("UTILIDAD") = .UTILIDAD_ME
                    End If
