...
Public Class clsConexionSunat
    'Private wServiceBeta As ServiceSUNAT_Comprobantes_Beta.billServiceClient
    ...
    Public Function EnviarGuia(pArchivo As String) As String
        Dim wServiceGuia As New ServiceSUNAT_Guias.billServiceClient
        ...
        If File.Exists(FilePath) = True Then
            ...
            Try
                ...
                wServiceGuia.Open()
                Dim returnByte As Byte() = wServiceGuia.sendBill(FileZip, byteArray, "")
                wServiceGuia.Close()
