Public Class entCuentaComercial
    ...
    Private m_telefono_otro As String
    Private m_celular As String
    Private m_fax As String
    Private m_email As String
    Private m_pagina_web As String
    Private m_direccion_trabajo As String
    Private m_referencia_trabajo As String
    Private m_telefono_trabajo As String
    ...
    Private m_apellido_casada As String
    Private m_nombres As String
    Private m_fecha_nacimiento As Date
    Private m_sexo As String

    Private m_estado_civil As String
    Private m_nivel_educativo As String
    Private m_ocupacion As String
    Private m_situacion_crediticia As String

    Private m_calificacion As String

    Private m_indica_preferente As String
    Private m_indica_fallecido As String
    Private m_exige_garante As String
    ...
    Private m_agencia_registro As String

    Private m_usuario_registro As String
    Private m_fecha_registro As Date

    Private m_agencia_modifica As String

    Private m_usuario_modifica As String
    Private m_fecha_modifica As Date

    Private m_usuario_aprobacion As String
    Private m_fecha_aprobacion As Date

    Private m_ultimo_producto_codigo As String
    Private m_ultimo_producto_fecha As Date

    Private m_nombre_conviviente As String
    ...
    Public Sub New()
        ...
        Me.telefono = Nothing
        Me.telefono_otro = Nothing
        Me.celular = Nothing
        Me.fax = Nothing
        Me.email = Nothing
        Me.pagina_web = Nothing
        Me.direccion_trabajo = Nothing
        Me.referencia_trabajo = Nothing
        Me.telefono_trabajo = Nothing
        ...
        Me.apellido_casada = Nothing
        Me.nombres = Nothing
        Me.fecha_nacimiento = Nothing
        Me.sexo = Nothing
        Me.estado_civil = Nothing
        Me.nivel_educativo = Nothing
        Me.ocupacion = Nothing
        Me.situacion_crediticia = Nothing
        Me.calificacion = Nothing
        Me.indica_preferente = Nothing
        Me.indica_fallecido = Nothing
        Me.exige_garante = Nothing
        ...
        Me.estado = Nothing
        Me.agencia_registro = Nothing
        Me.usuario_registro = Nothing
        Me.fecha_registro = Nothing
        Me.agencia_modifica = Nothing
        Me.usuario_modifica = Nothing
        Me.fecha_modifica = Nothing
        Me.usuario_aprobacion = Nothing
        Me.fecha_aprobacion = Nothing
        Me.ultimo_producto_codigo = Nothing
        Me.ultimo_producto_fecha = Nothing

        Me.nombre_conviviente = Nothing
    End Sub
    ...
    Public Sub New(ByVal CuentaComercial As entCuentaComercial)
        ...
        With CuentaComercial
            ...
            m_telefono = .telefono
            m_telefono_otro = .telefono_otro
            m_celular = .celular
            m_fax = .fax
            m_email = .email
            m_pagina_web = .pagina_web
            m_direccion_trabajo = .direccion_trabajo
            m_referencia_trabajo = .referencia_trabajo
            m_telefono_trabajo = .telefono_trabajo
            ...
            m_apellido_casada = .apellido_casada
            m_nombres = .nombres
            m_fecha_nacimiento = .fecha_nacimiento
            m_sexo = .sexo
            m_estado_civil = .estado_civil
            m_nivel_educativo = .nivel_educativo
            m_ocupacion = .ocupacion
            m_situacion_crediticia = .situacion_crediticia
            m_calificacion = .calificacion
            m_indica_preferente = .indica_preferente
            m_indica_fallecido = .indica_fallecido
            m_exige_garante = .exige_garante
            ...
            m_estado = .estado
            m_agencia_registro = .agencia_registro
            m_usuario_registro = .usuario_registro
            m_fecha_registro = .fecha_registro
            m_agencia_modifica = .agencia_modifica
            m_usuario_modifica = .usuario_modifica
            m_fecha_modifica = .fecha_modifica
            m_usuario_aprobacion = .usuario_aprobacion
            m_fecha_aprobacion = .fecha_aprobacion
            m_ultimo_producto_codigo = .ultimo_producto_codigo
            m_ultimo_producto_fecha = .ultimo_producto_fecha

            m_nombre_conviviente = .nombre_conviviente
        End With
    End Sub
    ...
    Public Property tipo_cuenta() As String
        ...
        End Get
        Set(ByVal value As String)
            m_tipo_cuenta = IIf(String.IsNullOrEmpty(value), "N", value)
        End Set
    End Property
    ...
    Public Property telefono_otro() As String
        Get
            Return m_telefono_otro
        End Get
        Set(ByVal value As String)
            m_telefono_otro = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property direccion_trabajo() As String
        Get
            Return m_direccion_trabajo
        End Get
        Set(ByVal value As String)
            m_direccion_trabajo = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property referencia_trabajo() As String
        Get
            Return m_referencia_trabajo
        End Get
        Set(ByVal value As String)
            m_referencia_trabajo = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property telefono_trabajo() As String
        ...
        End Get
        Set(ByVal value As String)
            m_telefono_trabajo = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property documento_pago() As String
        ...
        End Get
        Set(ByVal value As String)
            m_documento_pago = IIf(String.IsNullOrEmpty(value), "01", value)
        End Set
    End Property
    ...
    Public Property apellido_casada() As String
        Get
            Return m_apellido_casada
        End Get
        Set(ByVal value As String)
            m_apellido_casada = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property estado_civil() As String
        ...
        End Get
        Set(ByVal value As String)
            m_estado_civil = IIf(String.IsNullOrEmpty(value), "01", value)
        End Set
    End Property

    Public Property nivel_educativo() As String
        Get
            Return m_nivel_educativo
        End Get
        Set(ByVal value As String)
            m_nivel_educativo = IIf(String.IsNullOrEmpty(value), "07", value)
        End Set
    End Property
    ...
    Public Property ocupacion() As String
        ...
        End Get
        Set(ByVal value As String)
            m_ocupacion = IIf(String.IsNullOrEmpty(value), "002", value)
        End Set
    End Property

    Public Property situacion_crediticia() As String
        Get
            Return m_situacion_crediticia
        End Get
        Set(ByVal value As String)
            m_situacion_crediticia = IIf(String.IsNullOrEmpty(value), "NEW", value)
        End Set
    End Property
    ...
    Public Property indica_preferente() As String
        Get
            Return m_indica_preferente
        End Get
        Set(ByVal value As String)
            m_indica_preferente = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property

    Public Property indica_fallecido() As String
        Get
            Return m_indica_fallecido
        End Get
        Set(ByVal value As String)
            m_indica_fallecido = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property

    Public Property exige_garante() As String
        Get
            Return m_exige_garante
        End Get
        Set(ByVal value As String)
            m_exige_garante = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property
    ...
    Public Property item_flujo() As String
        ...
        End Get
        Set(ByVal value As String)
            m_item_flujo = IIf(String.IsNullOrEmpty(value), "9999", value)
        End Set
    End Property
    ...
    Public Property agencia_registro() As String
        Get
            Return m_agencia_registro
        End Get
        Set(ByVal value As String)
            m_agencia_registro = IIf(String.IsNullOrEmpty(value), "A0000000", value)
        End Set
    End Property
    ...
    Public Property agencia_modifica() As String
        Get
            Return m_agencia_modifica
        End Get
        Set(ByVal value As String)
            m_agencia_modifica = value
        End Set
    End Property
    ...
    Public Property usuario_aprobacion() As String
        Get
            Return m_usuario_aprobacion
        End Get
        Set(ByVal value As String)
            m_usuario_aprobacion = value
        End Set
    End Property
    ...
    Public Property fecha_aprobacion() As Date
        ...
        End Get
        Set(ByVal value As Date)
            m_fecha_aprobacion = IIf(value.Ticks = 0, Now, value)
        End Set
    End Property

    Public Property ultimo_producto_codigo() As String
        Get
            Return m_ultimo_producto_codigo
        End Get
        Set(ByVal value As String)
            m_ultimo_producto_codigo = value
        End Set
    End Property

    Public Property ultimo_producto_fecha() As Date
        Get
            Return m_ultimo_producto_fecha
        End Get
        Set(ByVal value As Date)
            m_ultimo_producto_fecha = IIf(value.Ticks = 0, Now, value)
        End Set
    End Property

    Public Property nombre_conviviente() As String
        Get
            Return m_nombre_conviviente
        End Get
        Set(ByVal value As String)
            m_nombre_conviviente = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
End Class