Public Class entOperacionAlmacen
    ...
    Private m_exige_guia As String

    Private m_afecta_stock As String
    Private m_indica_credito As String
    ...
    Public Sub New()
        ...
        Me.exige_guia = Nothing

        Me.afecta_stock = Nothing

        Me.indica_credito = Nothing
    End Sub
    ...
    Public Sub New(ByVal OperacionAlmacen As entOperacionAlmacen)
        ...
        With OperacionAlmacen
            ...
            m_exige_guia = .exige_guia
            m_afecta_stock = .afecta_stock

            m_indica_credito = .indica_credito
        End With
    End Sub
    ...
    Public Property referencia_tipo_moneda() As String
        ...
        End Get
        Set(ByVal value As String)
            m_referencia_tipo_moneda = IIf(String.IsNullOrEmpty(value), "1", value)
        End Set
    End Property
    ...
    Public Property poliza() As String
        ...
        End Get
        Set(ByVal value As String)
            m_poliza = IIf(String.IsNullOrEmpty(value), CUO_Nulo, value)
        End Set
    End Property
    ...
    Public Property exige_guia() As String
        Get
            Return m_exige_guia
        End Get
        Set(ByVal value As String)
            m_exige_guia = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property

    Public Property afecta_stock() As String
        Get
            Return m_afecta_stock
        End Get
        Set(ByVal value As String)
            m_afecta_stock = IIf(String.IsNullOrEmpty(value), "SI", value)
        End Set
    End Property

    Public Property indica_credito() As String
        Get
            Return m_indica_credito
        End Get
        Set(ByVal value As String)
            m_indica_credito = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property
