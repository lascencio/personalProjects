Public Class entProducto
    ...
    Private m_codigo_equivalente As String
    Private m_principio_activo As String
    ...
    Private m_cuenta_compra_cargo_mn As String
    Private m_cuenta_compra_cargo_me As String
    Private m_cuenta_compra_abono_mn As String
    Private m_cuenta_compra_abono_me As String
    Private m_cuenta_compra_destino_cargo_mn As String
    Private m_cuenta_compra_destino_cargo_me As String
    Private m_cuenta_compra_destino_abono_mn As String
    Private m_cuenta_compra_destino_abono_me As String
    Private m_cuenta_venta_cargo_mn As String
    Private m_cuenta_venta_cargo_me As String
    Private m_cuenta_venta_abono_mn As String
    Private m_cuenta_venta_abono_me As String
    Private m_cuenta_costo_cargo_mn As String
    Private m_cuenta_costo_cargo_me As String
    Private m_cuenta_costo_abono_mn As String
    Private m_cuenta_costo_abono_me As String
    Private m_cuenta_costo_destino_cargo_mn As String
    Private m_cuenta_costo_destino_cargo_me As String
    Private m_cuenta_costo_destino_abono_mn As String
    Private m_cuenta_costo_destino_abono_me As String
    Private m_cuenta_IGV_mn As String
    Private m_cuenta_IGV_me As String
    ...
    Private m_indica_producto_controlado As String
    Private m_indica_usado As String
    ...
    Private m_codigo_ean As String
    Private m_codigo_osce As String
    Private m_codigo_cubso As String
    Private m_codigo_unspsc As String
    ...
    Private m_indica_vehicular As String
    ...
    Public Sub New()
        ...
        Me.codigo_equivalente = Nothing
        Me.principio_activo = Nothing
        ...
        Me.cuenta_compra_cargo_mn = Nothing
        Me.cuenta_compra_cargo_me = Nothing
        Me.cuenta_compra_abono_mn = Nothing
        Me.cuenta_compra_abono_me = Nothing
        Me.cuenta_compra_destino_cargo_mn = Nothing
        Me.cuenta_compra_destino_cargo_me = Nothing
        Me.cuenta_compra_destino_abono_mn = Nothing
        Me.cuenta_compra_destino_abono_me = Nothing
        Me.cuenta_venta_cargo_mn = Nothing
        Me.cuenta_venta_cargo_me = Nothing
        Me.cuenta_venta_abono_mn = Nothing
        Me.cuenta_venta_abono_me = Nothing
        Me.cuenta_costo_cargo_mn = Nothing
        Me.cuenta_costo_cargo_me = Nothing
        Me.cuenta_costo_abono_mn = Nothing
        Me.cuenta_costo_abono_me = Nothing
        Me.cuenta_costo_destino_cargo_mn = Nothing
        Me.cuenta_costo_destino_cargo_me = Nothing
        Me.cuenta_costo_destino_abono_mn = Nothing
        Me.cuenta_costo_destino_abono_me = Nothing
        Me.cuenta_IGV_mn = Nothing
        Me.cuenta_IGV_me = Nothing
        ...
        Me.indica_producto_controlado = Nothing
        Me.indica_usado = Nothing
        ...
        Me.marca = Nothing
        Me.modelo = Nothing
        Me.codigo_ean = Nothing
        Me.codigo_osce = Nothing
        Me.codigo_cubso = Nothing
        Me.codigo_unspsc = Nothing
        Me.estado = Nothing
    ...
    Public Sub New(ByVal Producto As entProducto)
        With Producto
            ...
            m_codigo_equivalente = .codigo_equivalente
            m_principio_activo = .principio_activo
            ...
            m_cuenta_compra_cargo_mn = .cuenta_compra_cargo_mn
            m_cuenta_compra_cargo_me = .cuenta_compra_cargo_me
            m_cuenta_compra_abono_mn = .cuenta_compra_abono_mn
            m_cuenta_compra_abono_me = .cuenta_compra_abono_me
            m_cuenta_compra_destino_cargo_mn = .cuenta_compra_destino_cargo_mn
            m_cuenta_compra_destino_cargo_me = .cuenta_compra_destino_cargo_me
            m_cuenta_compra_destino_abono_mn = .cuenta_compra_destino_abono_mn
            m_cuenta_compra_destino_abono_me = .cuenta_compra_destino_abono_me
            m_cuenta_venta_cargo_mn = .cuenta_venta_cargo_mn
            m_cuenta_venta_cargo_me = .cuenta_venta_cargo_me
            m_cuenta_venta_abono_mn = .cuenta_venta_abono_mn
            m_cuenta_venta_abono_me = .cuenta_venta_abono_me
            m_cuenta_costo_cargo_mn = .cuenta_costo_cargo_mn
            m_cuenta_costo_cargo_me = .cuenta_costo_cargo_me
            m_cuenta_costo_abono_mn = .cuenta_costo_abono_mn
            m_cuenta_costo_abono_me = .cuenta_costo_abono_me
            m_cuenta_costo_destino_cargo_mn = .cuenta_costo_destino_cargo_mn
            m_cuenta_costo_destino_cargo_me = .cuenta_costo_destino_cargo_me
            m_cuenta_costo_destino_abono_mn = .cuenta_costo_destino_abono_mn
            m_cuenta_costo_destino_abono_me = .cuenta_costo_destino_abono_me
            m_cuenta_IGV_mn = .cuenta_IGV_mn
            m_cuenta_IGV_me = .cuenta_IGV_me
            ...
            m_indica_producto_controlado = .indica_producto_controlado
            m_indica_usado = .indica_usado
            ...
            m_marca = .marca
            m_modelo = .modelo
            m_codigo_ean = .codigo_ean
            m_codigo_osce = .codigo_osce
            m_codigo_cubso = .codigo_cubso
            m_codigo_unspsc = .codigo_unspsc
            m_estado = .estado
            ...
            m_indica_vehicular = .indica_vehicular
        End With
    End Sub
    ...
    Public Property codigo_equivalente() As String
        Get
            Return m_codigo_equivalente
        End Get
        Set(ByVal value As String)
            m_codigo_equivalente = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property principio_activo() As String
        Get
            Return m_principio_activo
        End Get
        Set(ByVal value As String)
            m_principio_activo = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property producto_sub_familia() As String
        ...
        End Get
        Set(ByVal value As String)
            m_producto_sub_familia = IIf(String.IsNullOrEmpty(value), "000", value)
        End Set
    End Property
    ...
    Public Property producto_sub_tipo() As String
        ...
        End Get
        Set(ByVal value As String)
            m_producto_sub_tipo = IIf(String.IsNullOrEmpty(value), "000", value)
        End Set
    End Property
    ...
    Public Property cuenta_compra_cargo_mn() As String
        Get
            Return m_cuenta_compra_cargo_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_cargo_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_cargo_me() As String
        Get
            Return m_cuenta_compra_cargo_me
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_cargo_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_abono_mn() As String
        Get
            Return m_cuenta_compra_abono_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_abono_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_abono_me() As String
        Get
            Return m_cuenta_compra_abono_me
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_abono_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_destino_cargo_mn() As String
        Get
            Return m_cuenta_compra_destino_cargo_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_destino_cargo_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_destino_cargo_me() As String
        Get
            Return m_cuenta_compra_destino_cargo_me
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_destino_cargo_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_destino_abono_mn() As String
        Get
            Return m_cuenta_compra_destino_abono_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_destino_abono_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_compra_destino_abono_me() As String
        Get
            Return m_cuenta_compra_destino_abono_me
        End Get
        Set(ByVal value As String)
            m_cuenta_compra_destino_abono_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_venta_cargo_mn() As String
        Get
            Return m_cuenta_venta_cargo_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_venta_cargo_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_venta_cargo_me() As String
        Get
            Return m_cuenta_venta_cargo_me
        End Get
        Set(ByVal value As String)
            m_cuenta_venta_cargo_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_venta_abono_mn() As String
        Get
            Return m_cuenta_venta_abono_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_venta_abono_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_venta_abono_me() As String
        Get
            Return m_cuenta_venta_abono_me
        End Get
        Set(ByVal value As String)
            m_cuenta_venta_abono_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_cargo_mn() As String
        Get
            Return m_cuenta_costo_cargo_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_cargo_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_cargo_me() As String
        Get
            Return m_cuenta_costo_cargo_me
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_cargo_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_abono_mn() As String
        Get
            Return m_cuenta_costo_abono_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_abono_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_abono_me() As String
        Get
            Return m_cuenta_costo_abono_me
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_abono_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_destino_cargo_mn() As String
        Get
            Return m_cuenta_costo_destino_cargo_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_destino_cargo_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_destino_cargo_me() As String
        Get
            Return m_cuenta_costo_destino_cargo_me
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_destino_cargo_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_destino_abono_mn() As String
        Get
            Return m_cuenta_costo_destino_abono_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_destino_abono_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_costo_destino_abono_me() As String
        Get
            Return m_cuenta_costo_destino_abono_me
        End Get
        Set(ByVal value As String)
            m_cuenta_costo_destino_abono_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_IGV_mn() As String
        Get
            Return m_cuenta_IGV_mn
        End Get
        Set(ByVal value As String)
            m_cuenta_IGV_mn = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property cuenta_IGV_me() As String
        Get
            Return m_cuenta_IGV_me
        End Get
        Set(ByVal value As String)
            m_cuenta_IGV_me = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property indica_producto_controlado() As String
        Get
            Return m_indica_producto_controlado
        End Get
        Set(ByVal value As String)
            m_indica_producto_controlado = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property

    Public Property indica_usado() As String
        Get
            Return m_indica_usado
        End Get
        Set(ByVal value As String)
            m_indica_usado = IIf(String.IsNullOrEmpty(value), "SI", value)
        End Set
    End Property
    ...
    Public Property imagen() As String
        ...
        End Get
        Set(ByVal value As String)
            m_imagen = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property marca() As String
        ...
        End Get
        Set(ByVal value As String)
            m_marca = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property modelo() As String
        ...
        End Get
        Set(ByVal value As String)
            m_modelo = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property codigo_ean() As String
        ...
        End Get
        Set(ByVal value As String)
            m_codigo_ean = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property codigo_osce() As String
        Get
            Return m_codigo_osce
        End Get
        Set(ByVal value As String)
            m_codigo_osce = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property codigo_cubso() As String
        Get
            Return m_codigo_cubso
        End Get
        Set(ByVal value As String)
            m_codigo_cubso = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property

    Public Property codigo_unspsc() As String
        Get
            Return m_codigo_unspsc
        End Get
        Set(ByVal value As String)
            m_codigo_unspsc = IIf(String.IsNullOrEmpty(value), Space(1), value)
        End Set
    End Property
    ...
    Public Property indica_vehicular() As String
        Get
            Return m_indica_vehicular
        End Get
        Set(ByVal value As String)
            m_indica_vehicular = IIf(String.IsNullOrEmpty(value), "NO", value)
        End Set
    End Property
